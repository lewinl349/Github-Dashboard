...
import { addTODOEntry, getTODOEntries, deleteTODOEntry, completeTODO, editTODOEntry, getDueSoonEntries } from '../databaseHelper';
...
router.get('/TODO/due_soon', async (req, res) => {
    try {
        const data = await getDueSoonEntries();
        res.json(data);
